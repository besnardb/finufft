...
int cufinufftf_execute(cufinufftf_plan d_plan, hipFloatComplex *d_c,
...
*/
{
  ...
  opts->gpu_np             = 0;
  opts->debug              = 0;
  opts->gpu_stream         = hipStreamDefault;
...
int cufinufft1d1many(int n_transf, i64 nj, const double *xj, const hipDoubleComplex *cj,
                     int iflag, double eps, i64 ms, hipDoubleComplex *fk,
                     const cufinufft_opts *opts) {
  return guru13<double>(1, 1, n_transf, nj, {xj}, cj, iflag, eps, {ms, 1, 1}, 0, {}, fk,
                        opts);
}
int cufinufftf1d1many(int n_transf, i64 nj, const float *xj, const hipFloatComplex *cj,
                      int iflag, float eps, i64 ms, hipFloatComplex *fk,
                      const cufinufft_opts *opts) {
  return guru13<float>(1, 1, n_transf, nj, {xj}, cj, iflag, eps, {ms, 1, 1}, 0, {}, fk,
                       opts);
}
int cufinufft1d1(i64 nj, const double *xj, const hipDoubleComplex *cj, int iflag,
                 double eps, i64 ms, hipDoubleComplex *fk, const cufinufft_opts *opts) {
  return cufinufft1d1many(1, nj, xj, cj, iflag, eps, ms, fk, opts);
}
int cufinufftf1d1(i64 nj, const float *xj, const hipFloatComplex *cj, int iflag, float eps,
                  i64 ms, hipFloatComplex *fk, const cufinufft_opts *opts) {
  return cufinufftf1d1many(1, nj, xj, cj, iflag, eps, ms, fk, opts);
}

int cufinufft1d2many(int n_transf, i64 nj, const double *xj, hipDoubleComplex *cj,
                     int iflag, double eps, i64 ms, const hipDoubleComplex *fk,
                     const cufinufft_opts *opts) {
  return guru2<double>(1, 2, n_transf, nj, {xj}, cj, iflag, eps, {ms, 1, 1}, 0, {}, fk,
                       opts);
}
int cufinufftf1d2many(int n_transf, i64 nj, const float *xj, hipFloatComplex *cj,
                      int iflag, float eps, i64 ms, const hipFloatComplex *fk,
                      const cufinufft_opts *opts) {
  return guru2<float>(1, 2, n_transf, nj, {xj}, cj, iflag, eps, {ms, 1, 1}, 0, {}, fk,
                      opts);
}
int cufinufft1d2(i64 nj, const double *xj, hipDoubleComplex *cj, int iflag, double eps,
                 i64 ms, const hipDoubleComplex *fk, const cufinufft_opts *opts) {
  return cufinufft1d2many(1, nj, xj, cj, iflag, eps, ms, fk, opts);
}
int cufinufftf1d2(i64 nj, const float *xj, hipFloatComplex *cj, int iflag, float eps,
                  i64 ms, const hipFloatComplex *fk, const cufinufft_opts *opts) {
  return cufinufftf1d2many(1, nj, xj, cj, iflag, eps, ms, fk, opts);
}

int cufinufft1d3many(int n_transf, i64 nj, const double *xj, const hipDoubleComplex *cj,
                     int iflag, double eps, i64 nk, const double *s, hipDoubleComplex *fk,
                     const cufinufft_opts *opts) {
  return guru13<double>(1, 3, n_transf, nj, {xj}, cj, iflag, eps, {0, 0, 0}, nk, {s}, fk,
                        opts);
}
int cufinufftf1d3many(int n_transf, i64 nj, const float *xj, const hipFloatComplex *cj,
                      int iflag, float eps, i64 nk, const float *s, hipFloatComplex *fk,
                      const cufinufft_opts *opts) {
  return guru13<float>(1, 3, n_transf, nj, {xj}, cj, iflag, eps, {0, 0, 0}, nk, {s}, fk,
                       opts);
}
int cufinufft1d3(i64 nj, const double *xj, const hipDoubleComplex *cj, int iflag,
                 double eps, i64 nk, const double *s, hipDoubleComplex *fk,
                 const cufinufft_opts *opts) {
  return cufinufft1d3many(1, nj, xj, cj, iflag, eps, nk, s, fk, opts);
}
int cufinufftf1d3(i64 nj, const float *xj, const hipFloatComplex *cj, int iflag, float eps,
                  i64 nk, const float *s, hipFloatComplex *fk,
                  const cufinufft_opts *opts) {
...
int cufinufft2d1many(int n_transf, i64 nj, const double *xj, const double *yj,
                     const hipDoubleComplex *cj, int iflag, double eps, i64 ms, i64 mt,
                     hipDoubleComplex *fk, const cufinufft_opts *opts) {
...
int cufinufftf2d1many(int n_transf, i64 nj, const float *xj, const float *yj,
                      const hipFloatComplex *cj, int iflag, float eps, i64 ms, i64 mt,
                      hipFloatComplex *fk, const cufinufft_opts *opts) {
  return guru13<float>(2, 1, n_transf, nj, {xj, yj}, cj, iflag, eps, {ms, mt, 1}, 0, {},
                       fk, opts);
}
int cufinufft2d1(i64 nj, const double *xj, const double *yj, const hipDoubleComplex *cj,
                 int iflag, double eps, i64 ms, i64 mt, hipDoubleComplex *fk,
                 const cufinufft_opts *opts) {
  return cufinufft2d1many(1, nj, xj, yj, cj, iflag, eps, ms, mt, fk, opts);
}
int cufinufftf2d1(i64 nj, const float *xj, const float *yj, const hipFloatComplex *cj,
                  int iflag, float eps, i64 ms, i64 mt, hipFloatComplex *fk,
                  const cufinufft_opts *opts) {
...
int cufinufft2d2many(int n_transf, i64 nj, const double *xj, const double *yj,
                     hipDoubleComplex *cj, int iflag, double eps, i64 ms, i64 mt,
                     const hipDoubleComplex *fk, const cufinufft_opts *opts) {
...
int cufinufftf2d2many(int n_transf, i64 nj, const float *xj, const float *yj,
                      hipFloatComplex *cj, int iflag, float eps, i64 ms, i64 mt,
                      const hipFloatComplex *fk, const cufinufft_opts *opts) {
  return guru2<float>(2, 2, n_transf, nj, {xj, yj}, cj, iflag, eps, {ms, mt, 1}, 0, {},
                      fk, opts);
}
int cufinufft2d2(i64 nj, const double *xj, const double *yj, hipDoubleComplex *cj,
                 int iflag, double eps, i64 ms, i64 mt, const hipDoubleComplex *fk,
                 const cufinufft_opts *opts) {
  return cufinufft2d2many(1, nj, xj, yj, cj, iflag, eps, ms, mt, fk, opts);
}
int cufinufftf2d2(i64 nj, const float *xj, const float *yj, hipFloatComplex *cj, int iflag,
                  float eps, i64 ms, i64 mt, const hipFloatComplex *fk,
                  const cufinufft_opts *opts) {
...
int cufinufft2d3many(int n_transf, i64 nj, const double *xj, const double *yj,
                     const hipDoubleComplex *cj, int iflag, double eps, i64 nk,
                     const double *s, const double *t, hipDoubleComplex *fk,
                     const cufinufft_opts *opts) {
...
int cufinufftf2d3many(int n_transf, i64 nj, const float *xj, const float *yj,
                      const hipFloatComplex *cj, int iflag, float eps, i64 nk,
                      const float *s, const float *t, hipFloatComplex *fk,
                      const cufinufft_opts *opts) {
  return guru13<float>(2, 3, n_transf, nj, {xj, yj}, cj, iflag, eps, {0, 0, 0}, nk,
                       {s, t}, fk, opts);
}
int cufinufft2d3(i64 nj, const double *xj, const double *yj, const hipDoubleComplex *cj,
                 int iflag, double eps, i64 nk, const double *s, const double *t,
                 hipDoubleComplex *fk, const cufinufft_opts *opts) {
  return cufinufft2d3many(1, nj, xj, yj, cj, iflag, eps, nk, s, t, fk, opts);
}
int cufinufftf2d3(i64 nj, const float *xj, const float *yj, const hipFloatComplex *cj,
...
int cufinufft3d1many(int n_transf, i64 nj, const double *xj, const double *yj,
                     const double *zj, const hipDoubleComplex *cj, int iflag, double eps,
                     i64 ms, i64 mt, i64 mu, hipDoubleComplex *fk,
                     const cufinufft_opts *opts) {
...
int cufinufftf3d1many(int n_transf, i64 nj, const float *xj, const float *yj,
                      const float *zj, const hipFloatComplex *cj, int iflag, float eps,
                      i64 ms, i64 mt, i64 mu, hipFloatComplex *fk,
                      const cufinufft_opts *opts) {
...
int cufinufft3d1(i64 nj, const double *xj, const double *yj, const double *zj,
                 const hipDoubleComplex *cj, int iflag, double eps, i64 ms, i64 mt, i64 mu,
                 hipDoubleComplex *fk, const cufinufft_opts *opts) {
...
int cufinufftf3d1(i64 nj, const float *xj, const float *yj, const float *zj,
                  const hipFloatComplex *cj, int iflag, float eps, i64 ms, i64 mt, i64 mu,
                  hipFloatComplex *fk, const cufinufft_opts *opts) {
...
int cufinufft3d2many(int n_transf, i64 nj, const double *xj, const double *yj,
                     const double *zj, hipDoubleComplex *cj, int iflag, double eps, i64 ms,
                     i64 mt, i64 mu, const hipDoubleComplex *fk,
                     const cufinufft_opts *opts) {
...
int cufinufftf3d2many(int n_transf, i64 nj, const float *xj, const float *yj,
                      const float *zj, hipFloatComplex *cj, int iflag, float eps, i64 ms,
                      i64 mt, i64 mu, const hipFloatComplex *fk,
                      const cufinufft_opts *opts) {
...
int cufinufft3d2(i64 nj, const double *xj, const double *yj, const double *zj,
                 hipDoubleComplex *cj, int iflag, double eps, i64 ms, i64 mt, i64 mu,
                 const hipDoubleComplex *fk, const cufinufft_opts *opts) {
...
int cufinufftf3d2(i64 nj, const float *xj, const float *yj, const float *zj,
                  hipFloatComplex *cj, int iflag, float eps, i64 ms, i64 mt, i64 mu,
                  const hipFloatComplex *fk, const cufinufft_opts *opts) {
...
int cufinufft3d3(i64 nj, const double *xj, const double *yj, const double *zj,
                 const hipDoubleComplex *cj, int iflag, double eps, i64 nk,
                 const double *s, const double *t, const double *u, hipDoubleComplex *fk,
                 const cufinufft_opts *opts) {
...
int cufinufftf3d3(i64 nj, const float *xj, const float *yj, const float *zj,
                  const hipFloatComplex *cj, int iflag, float eps, i64 nk, const float *s,
                  const float *t, const float *u, hipFloatComplex *fk,
                  const cufinufft_opts *opts) {
